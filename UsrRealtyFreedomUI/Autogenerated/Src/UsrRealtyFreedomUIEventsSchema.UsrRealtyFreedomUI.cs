namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyFreedomUIEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("e9c535d5-4d0b-44b1-8809-894c662e908d");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("b6fcdbd5-fda7-9a26-b62b-c12c8270e458"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("3cf935ca-c7a1-4f7b-a9cb-fab72eccb5ed"),
				CreatedInSchemaUId = new Guid("e9c535d5-4d0b-44b1-8809-894c662e908d"),
				ModifiedInSchemaUId = new Guid("e9c535d5-4d0b-44b1-8809-894c662e908d")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("e9c535d5-4d0b-44b1-8809-894c662e908d"));
		}
